...
前往`https://wesosoft.github.io/`下载最新`weso`，放入到`C盘`(也可以放入其他任意位置)。

使用如下命令创建项目：
```
C:/weso.exe -d -w D:\MyWork\test_window
```
...
本项目可以直接下载：[https://wesosoft.github.io/docs/demo/zip/test_window.zip](https://wesosoft.github.io/docs/demo/zip/test_window.zip)